...
export const data = [
  ...
  { id: 10, title: "Editor", icon: <FaRegEdit />, link: "/apps/editor" },
  {
    id: 11,
    title: "Color Picker",
  ...
  { id: 13, title: "Line", icon: <LuLineChart />, link: "/charts/line" },
  { id: 14, title: "Area", icon: <AiOutlineAreaChart />, link: "/charts/area" },
  { id: 15, title: "Bar", icon: <FaRegChartBar />, link: "/charts/bar" },
  { id: 16, title: "Pie", icon: <FiPieChart />, link: "/charts/pie" },
];
